...
class MaskRCNN:
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            anchors = KL.Lambda(
                lambda x: tf.Variable(anchors, dtype=dtype), name="anchors"
            )(input_image)
        else:
        ...
        if mode == "training":
            ...
            if config.MASK_SHARE:
                mask_loss = KL.Lambda(
                    lambda x: mrcnn_one_mask_loss_graph(*x), name="mrcnn_mask_loss"
    ...
    def detect(self, images, verbose=0):
        ...
        detections, _, _, mrcnn_mask, rpn_roi, rpn_score, _ = self.keras_model.predict(
